...
<div id="bodyContainer">
	...
	<!-- main text area that occupies 2/3rds of the page width -->
	  <div class="topic_main_2over3">
		<h1 class="title_article">基督教域多利华人宣道会欢迎您 </h1>
		...
		<div class="topic_sidebar">
			<div class="topic_sidebarTitle">最新消息</div>
		    <a href="#">英语堂圣诞茶聚</a><br />
		    <br />
		    <a href="#">国粤语布道会</a><br />
		    <br />
		    <a href="#">周一运动之夜取消</a><br />
		    <br />
		</div>
		<!-- topic_sidebar -->
...
<table width="872" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    <td width="290"><div class="real-content-3col-title"><a href="#">英语崇拜 </a></div></td>
    <td width="290"><div class="real-content-3col-title"><a href="#">粤语崇拜</a> </div></td>
    <td width="290"><div class="real-content-3col-title"><a href="#">国语崇拜</a></div></td>
  </tr>
  <tr>
